  ...
  render () {
    return (
        ...
        <ol style={{textAlign: 'left'}}>
          ...
          <p><span>&#10003;</span>Load the "Course" component as a nested component of "Courses"</p>
          <p><span>&#10003;</span>Add a 404 error page and render it for any unknown routes</p>
          <p><span>&#10003;</span>Redirect requests to /all-courses to /courses (=> Your "Courses" page)</p>
        </ol>
